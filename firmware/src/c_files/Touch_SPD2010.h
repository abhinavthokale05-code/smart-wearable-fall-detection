...
// MUST be volatile: written inside an ISR (Touch_SPD2010_ISR),
// read from the main loop / LVGL callback. Without volatile the compiler
// caches the value in a register and the main loop never sees the update.
